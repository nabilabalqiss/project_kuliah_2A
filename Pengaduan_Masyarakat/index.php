...
<head>
    ...
    <title>Dispendukcapil Bireun</title>
    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">
                <img alt="Brand" src="images/download.png" width="30" height="30" class="d-inline-block align-top" alt="">
            </class=>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">PROFIL DINAS <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="motto-maklumat">Motto / Maklumat Pelayanan</a></li>
                    </ul>
                </li>
                <li><a href="faq">FAQ</a></li>
                <li><a href="bantuan">BANTUAN</a></li>
                <li><a href="kontak">KONTAK</a></li>
                <li><a class="btn btn-primary" onclick="window.location.href='admin/login.php'">Login</a></li>
            </ul>
        </div>
    </div>
</nav>
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="carousel-caption welcome">
                    ...
                    <h3 class="animated bounceInLeft">Website Pengaduan Masyarakat Dispendukcapil Bireun</h3>
                </div>
            </div>
            <div class="item">
        ...
        <footer class="footer text-center">
            <div class="row">
                <div class="col-md-4 mb-5 mb-lg-0">
                    ...
                    <p class="mb-0">
                        Jl. Sultan Malikulssaleh Cot Gapu
                        <br>Bireuen, Aceh Indonesia
                        <br>Kode Pos 24251
                    </p>
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="mb-0">
                            031-3095331 <br>
                            dispendukcapil@bireunkab.go.id <br>
                            dispendukcapil.bireun@gmail.com
                        </p>
                    </div>
                </div>
